...
const customTuningBotDirection = chooseBotDirection(botSession, {
  ...defaultBotTuning,
  bulletDangerWeight: defaultBotTuning.bulletDangerWeight + 1,
});
assert.notEqual(customTuningBotDirection.x, 1);
